...
$dbname = "patientsignupform"; // The database name you created earlier
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert the data into the signupform(1) table
    $sql = "INSERT INTO signupform(1) (username, email, password, confirm_password) 
