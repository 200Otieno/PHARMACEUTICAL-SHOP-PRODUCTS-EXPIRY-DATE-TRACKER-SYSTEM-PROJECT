...
$dbname = "systemadministratorsignupform"; // The database name you created earlier
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert the data into the signupform(2) table
    $sql = "INSERT INTO signupform(2) (username, email, password, confirm_password) 
